...
- `CMP-OUTBOX-PUBLISHER`: consumidor de DynamoDB Streams que publica eventos a EventBridge.
...
**What belongs here:** containers, data ownership, protocolos principales, runtime responsibility.
